        ...
        <div className="mt-20 mb-10 flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="md:w-[400px]">
            ...
            <p className="my-8 text-Black/75">
             Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab architecto consequatur debitis deserunt distinctio dolore eligendi est eum eveniet labore laborum laudantium mollitia nemo obcaecati perferendis possimus quia, temporibus voluptates?
            </p>
